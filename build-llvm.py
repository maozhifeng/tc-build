...
def versioned_binaries(binary_name):
    ...
    return ['%s-%s' % (binary_name, i) for i in range(11, 5, -1)] + [binary_name]
...
def fetch_llvm_binutils(args, dirs, shallow=False):
    """
...
def main():
    ...
    fetch_llvm_binutils(args, dirs, args.shallow_clone)
